...
*   - Resturant Conatiner
*       - Resturant Image
*       - Resturant Name, rating, cost for two
*  FOOTER
*   - Copyright
*   - Contact Us
*/
                        ...
                        "restaurants": [
                            {
                                "info": {
                                    ...
                                    "availability": {
                                        "nextCloseTime": "2024-02-13 05:00:00",
                                        "opened": true
                                    },
                                    "badges": {},
                                    "isOpen": true,
                            ...
                            },
                            {
                                "info": {
                                    ...
                                    "availability": {
                                        "nextCloseTime": "2024-02-13 03:15:00",
                                        "opened": true
                                    },
                                    "badges": {
                                        "textExtendedBadges": [
                            ...
                            },
                            {
                                "info": {
                                    ...
                                    "availability": {
                                        "nextCloseTime": "2024-02-13 00:59:00",
                                        "opened": true
                                    },
                                    "badges": {},
                                    "isOpen": true,
                            ...
                            },
                            {
                                "info": {
                                    ...
                                    "availability": {
                                        "nextCloseTime": "2024-02-12 23:45:00",
                                        "opened": true
                                    },
                                    "badges": {
                                        "imageBadges": [
                            ...
                            },
                            {
                                "info": {
                                    ...
                                    "availability": {
                                        "nextCloseTime": "2024-02-12 22:30:00",
                                        "opened": true
                                    },
                                    "badges": {
                                        "imageBadges": [
...
// console.log(resData[0].card.card.gridElements.infoWithStyle.restaurants)

const Header = () => {
    return (
        <div className="header">
            <div className="logo">
                <img className="logo-img" alt="logo" src="https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png" />
            </div>
...
const ResturandCard = (props) => {
    ...
    return (
        <div className="res-card">
            <img className="res-image" alt="res-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" +
                cloudinaryImageId} />
            <h3>{name}</h3>
            <h4>{cuisines.join(",")}</h4>
