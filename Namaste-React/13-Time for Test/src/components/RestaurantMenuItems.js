    ...
    return (<div>
        ...
        {items.map((item) =>
            <div className="p-2 m-2 border-b-custom-width border-custom-brown text-left" key={item?.card?.info?.id}>
                ...
                <button className="p-1 px-4 bg-custom-light-yellow shadow-lg mt-[-28px] absolute right-[23rem] rounded font-semibold hover:border-2 hover:border-custom-yellow"
